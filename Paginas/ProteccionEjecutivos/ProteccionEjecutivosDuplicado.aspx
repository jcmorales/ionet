...
<!--Nombre del documento: ProteccionEjecutivosDuplicado -->
...
async: false,
	...
	function obtenerDatos(identificador) {
		$.ajax({
			url:URL + "/_api/web/lists/getbytitle('TR_ProteccionEjecutivos')/Items?$select= NombreReporte,NumeroReporte,Title&$orderby = ID &$filter=ID eq '" + encodeURIComponent(identificador) + "'",
			type: "GET",
async: false,
			headers: {"accept": "application/json;odata=verbose"},
			success: function (data) {
	...
	function obtener() {
		...
		var e = {
			...
			'NombreReporte':'ProteccionEjecutivosDuplicado'
		};
