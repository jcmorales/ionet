...
<h3 id="lblExtravío/DentroUO/Producto">Extravío/DentroUO/Producto</h3>
	...
	<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
		...
		<input class='form-control text' idvariabledepende ='Producto' maxlength='100' id='txtProducto' type='text'/>
	</div>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control moneda' idvariabledepende ='MontodelProducto' maxlength='20' id='txtMontodelProducto' type='text'/>
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
