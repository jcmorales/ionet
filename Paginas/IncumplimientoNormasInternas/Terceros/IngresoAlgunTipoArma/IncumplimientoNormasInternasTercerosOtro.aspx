...
async: false,
	...
	function validarCampos() {
		...
		if($('#txtNumero').val() === ''){
			...
			$('#txtNumero').css('border-color', '#D8D8D8');
		}
		if($('#txtColonia').val() === ''){
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control' idvariabledepende ='Numero' maxlength='100' id='txtNumero' type='text'/>
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control' idvariabledepende ='Estado' maxlength='50' id='txtEstado' type='text'/>
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
