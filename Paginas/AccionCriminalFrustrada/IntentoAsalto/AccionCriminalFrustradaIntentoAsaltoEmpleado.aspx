...
$('#txtEspecificaArma').css('border-color', '#D8D8D8');
	...
	function DuplicarGrupo(claseDuplicados, elementChild) {
		...
		$("[id^='tarSenasParticulares']").each(function( index ) {
			$(this).height("20px");
		});
		
		$("[id^='tarMasrasgos']").each(function( index ) {
			$(this).height("21px");
		});
		
		$("[id^='tarOtros']").each(function( index ) {
			$(this).height("20px");
		});
		...
		<div class='col-xs-12 col-lg-12 col-md-12 col-xl-12' >
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblTipoArma'>* Tipo de Arma</label>
					<select class='form-control select' id='LstTipoArma_' onchange="getEspecificaArma();">
							<option></option>
					</select>
			</div>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<textarea style='height:34px !important' maxlength='1000' id='tarSenasParticulares' class='form-control area' rows='5' ></textarea>
			</div>
