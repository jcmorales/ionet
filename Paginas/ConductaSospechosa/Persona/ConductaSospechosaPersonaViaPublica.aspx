...
<h3 id="lblConductaSospechosaPersonaViaPublica">ConductaSospechosaPersonaViaPublica</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMunicipio'  list='dtlMun' onfocus='getMun();'>* Municipio</label>
	...
	<section class="DelincuentesD">
		<div class='container DDelincuentes' style="visibility:hidden; display:none">
			<div class='col-xs-12 col-lg-12 col-md-12 col-xl-12'>
				<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
					<label class='control-label' id= 'lblGeneroDelincuente'  >* Género delincuente</label>
				...
				<div class='col-xs-12 col-lg-12 col-md-12 col-xl-12'></div>
				<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
					<label class='control-label' id= 'lblTamanioCabello'  >* Tamaño cabello</label>
					<select class='form-control select' id='LstTamanioCabello_'   >
						<option></option>
					</select>
				</div>
				<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
					<label class='control-label' id= 'lblColorCabello'  >* Color cabello</label>
