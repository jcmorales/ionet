...
function sumarMonto()
	{
	    ...
	    resultado= tmontoefectivo + tmontoderecuperacion + tmontoaproximadoen + totrosmontos + toAproximadodelProducto;
	    //alert(resultado);
...
<h3 id="lblPerdidasPatrimonialesUnidadOperativaMaestros">PerdidasPatrimonialesUnidadOperativaMaestros</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			...
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblMontoAproximadoenproducto'>* Monto aproximado del producto</label>
