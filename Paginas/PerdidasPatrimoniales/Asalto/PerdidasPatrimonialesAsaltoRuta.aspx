...
EliminarDatosDelincuentes($('#hdnidentificador').val(), $('#hdnnumero').val());
	...
	function gotAccount(sender, args) {
		...
		var cEstatusCaja= document.getElementById('LstEstatusCaja_');
		llenarObjSelect(cEstatusCaja, vEstatusCaja);
...
async: false,
	...
	function bloquear(can_ubi, can_equi, can_per) {
		...
		$('#LstEstatusCaja_').prop('disabled', true);
...
$('#txtEspecificaArma').css('border-color', '#D8D8D8');
	...
	alert('No se puede continuar porque el campo * Detenidos está vacío');
		...
		if($('#LstEstatusCaja_ option:selected').text() === '...' || $('#LstEstatusCaja_ option:selected').text() === '') {
			$('#LstEstatusCaja_').css('border-color', 'red');
	alert('No se puede continuar porque el campo * Status de caja está vacío');
			return false;
		}else{
			$('#LstEstatusCaja_').css('border-color', '#D8D8D8');
		}
		if($('#txtCalle').val() === ''){
	...
	function obtener() {
		...
		var e = {
			...
			'StatusCaja': $('#LstEstatusCaja_ option:selected').text(),
			'Calle': $('#txtCalle').val(),
...
$( "input[id^='txtCantidad']" ).blur(function() {
			...
			$('#txtMontoAproximadoenproducto').priceFormat({
				prefix: '$ ',
				centsSeparator: '.', 
				thousandsSeparator: ','
			});
		...
		$( "input[id^='txtMontoCliente']" ).blur(function() {
			...
			$('#txtAcumulacionMonto').priceFormat({
				prefix: '$ ',
				centsSeparator: '.', 
				thousandsSeparator: ','
			});
...
function sumarMonto ()
	{
	    var resultado="";
	    var montodeAcumulado = document.getElementById('txtMontodeEfectivo').value;
...
<h3 id="lblPerdidasPatrimonialesAsaltoRuta">PerdidasPatrimonialesAsaltoRuta</h3>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				...
				<input class='form-control' idvariabledepende ='Placas2' maxlength='10' id='txtPlacas2' type='text'  />
			</div>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
	...
	<div id="ctHoraEvento" class='container'>
		<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
			<div class='col-xs-6 col-md-4 col-lg-3 col-xl-3 form-group'>
				<label class='control-label' id= 'lblEstatusCaja'>* Status de caja</label>
				<select class='form-control' id='LstEstatusCaja_'   >
					<option></option>
				</select>
			</div>
		</div>
